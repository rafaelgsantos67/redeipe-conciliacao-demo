...
- **Conciliação** — tabela venda × recebível com ordenação, busca, filtros e modal de detalhes com linha do tempo (venda → captura → liquidação). Divergências dos 5 tipos reais do setor: taxa maior que a contratada, venda não localizada, chargeback, duplicidade e tarifa de POS não prevista.
...
- **Recebíveis** — agenda dos próximos 40 dias por adquirente e simulador de antecipação.
...
Os filtros globais de **unidade** e **período** atualizam todas as abas.
